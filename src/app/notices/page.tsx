      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-pink-100 dark:from-gray-900 dark:to-gray-800">
        <Card className="max-w-md mx-4">
          <CardContent className="text-center py-12">
            ...
            <Button
              onClick={() => fetchNotices(debouncedSearchTerm)}
              className="mt-4"
            >
              Retry
            </Button>
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 ">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 bg-white/80 backdrop-blur-sm border-gray-200 focus:border-blue-400 dark:bg-transparent"
            />
          </div>
          ...
          <Button
            ...
            className="min-w-fit dark:bg-gray-300"
          >
        ...
        {/* Stats */}
        <div className="flex gap-4 text-sm text-gray-600 dark:text-gray-400 dark:bg-transparent">
      ...
      {!loading && (
        <>
          {displayNotices.length === 0 ? (
            <Card className="bg-white/80 backdrop-blur-sm border-gray-200 dark:bg-transparent">
