...
export default function HomePage() {
  const instituteDetails = {
    ...
    description: "Premier online education platform providing quality courses and training for students across Bangladesh.",
    shortHeadings: [
    ...
    testimonials: [
      {
        ...
        content: "Learnhub Academy transformed my understanding of programming."
      },
      {
        id: 2,
        name: "Fatima Khatun",
        role: "Business Management",
        content: "The flexibility of online learning at Learnhub allowed me to balance my studies with work."
      }
    ],
    contact: {
  ...
  useEffect(() => {
    const headingInterval = setInterval(() => {
      setCurrentHeadingIndex((prevIndex) =>
        prevIndex === instituteDetails.shortHeadings.length - 1 ? 0 : prevIndex + 1
      );
    }, 8000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-rose-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
      <Header />
      <div className="px-2 xs:px-6 sm:px-8 lg:px-14">
        {showHeadings && (
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-6 lg:gap-8 items-start">
            ...
            <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col pt-4 xl:pt-10">
              ...
              {/* Reduced margin */}
              <div className="mb-6">
                <h2 className="text-xl sm:text-2xl font-semibold text-slate-800 dark:text-slate-200 mb-3">Why Choose Us?</h2>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button variant="outline" className="border-2 border-red-700 text-red-700 hover:bg-red-700 hover:text-white px-6 py-3 rounded-xl text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  Contact Now
                </Button>
              </div>
            </div>
