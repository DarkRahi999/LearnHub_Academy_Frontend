...
export default function Header() {
    ...
    return (
        <header className="animate-slide-in-down bg-background border-b sticky top-0 z-20 px-4 xs:px-6 sm:px-10 lg:px-20 h-12 p-2 transition-all duration-300 ease-in-out shadow-sm hover:shadow-lg animate-pulse-glow dark:bg-slate-900/90 dark:border-slate-800">
                ...
                <>
                    ...
                    >
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <span className="text-white text-4xl font-bold opacity-30">WhatsApp</span>
                        </div>
                    </div>


                    {/*________________ Menu Panel ________________*/}
                    <div className="fixed top-12 right-0 w-1/2 max-w-xs h-screen bg-background/95 border-l border-border shadow-2xl z-50 sm:hidden dark:bg-slate-900/95 dark:border-slate-800">
                            ...
                            {loading ? (
                                ...
                                <>
                                    <div className="space-y-2">
                                        ...
                                        <Button variant="ghost" className="w-full justify-start h-12 text-left transition-all duration-300 ease-in-out hover:bg-accent/50 hover:scale-105 hover:translate-x-2" onClick={() => setIsMobileMenuOpen(false)}>
            ...
            {isDesktopProfileOpen && (
                <>
                    ...
                    />
                    {/* Right Panel */}
                    <div className="fixed top-12 right-0 h-screen w-1/4 bg-background/95 border-l border-border shadow-2xl z-50 hidden sm:block dark:bg-slate-900/95 dark:border-slate-800">
