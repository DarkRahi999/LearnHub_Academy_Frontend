...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      ...
      "left-1/2 transform -translate-x-1/2", // Center the toast
      className
    )}
    {...props}
  />
